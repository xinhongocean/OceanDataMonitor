...
//**** GFS ************************************************************************/
    ...
    GFS9("http://weather1.xinhong.net/gfs/isosurfacedata?level=0500&elem=ICE",
            "GFS", "积冰填充"),
    GFS10("http://weather1.xinhong.net/gfs/isosurfacedata?level=0500&elem=CTH",
            "GFS", "云顶高"),
    GFS11("http://weather1.xinhong.net/gfs/isosurfacedata?level=0500&elem=TS",
            "GFS", "雷暴"),
    GFS12("http://weather1.xinhong.net/gfs/isosurfacedata?level=0500&elem=WSI",
            "GFS", "大风"),
    GFS13("http://weather1.xinhong.net/gfs/isosurfacedata?level=0500&elem=VIS",
            "GFS", "能见度"),
    GFS14("http://weather1.xinhong.net/gfs/isosurfacedata?level=0500&elem=CBH",
            "GFS", "云底高"),
